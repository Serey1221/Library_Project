...
<div id="wrapper">
        ...
        @include('main')
                <div class="container">
                    ...
                    <form action="/authors {{ route('post')}}" method="POST" class="row justify-content-center" enctype="multipart/form-data">
                        <div class="col-lg-6">
                            @csrf
                            <div class="m-2">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="m-2">
                                <div class="form-group">
                                    ...
                                    <input class="ml-4" type="file" placeholder="Enter photo" 

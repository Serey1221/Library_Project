...
<body id="page-top">
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            @include('main')
            <div class="container">
                <form action="/borrows" method="POST" class="row justify-content-center">
                    <div class="col-lg-6">
                        @csrf
                        <div class="m-2">
                        ...
                        <div class="m-2">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" placeholder="Enter borrow_date " name="borrow_date" id="borrow_date" value="{{ old('borrow_date') }}" />
                                @error('borrow_date')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="m-2">
                            ...
                            <a class="btn btn-info" href="/borrows">Back</a>
                        </div>
                    </div>
                </form>
            </div>

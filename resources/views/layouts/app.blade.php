...
<body id="page-top">
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/bookauthors">
                    <i class="fas fa-book-reader"></i>
                    <span>Bookauthor</span></a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/booktypes">
                    <i class="fas fa-book-open"></i>
                    <span>Booktype</span></a>
            </li>
            <li class="nav-item">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="{{ URL::asset('img/undraw_profile_1.svg'); }}" alt="...">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="{{ URL::asset('img/undraw_profile_3.svg'); }}" alt="...">
